...
Motor_A_Adelante = DigitalInOut(board.GP18)
Motor_A_Atras = DigitalInOut(board.GP19)
Motor_B_Adelante = DigitalInOut(board.GP20)
Motor_B_Atras = DigitalInOut(board.GP21)
...
Enable_A = pwmio.PWMOut(board.GP15, frequency=1000, duty_cycle=65535)  # Máxima velocidad
Enable_B = pwmio.PWMOut(board.GP14, frequency=1000, duty_cycle=65535)  # Máxima velocidad
